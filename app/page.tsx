      ...
      <div className="mx-auto max-w-3xl rounded-2xl bg-white p-8 shadow-sm">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border p-4">
            ...
            <p className="mt-1 text-sm text-gray-600">Réseaux, dev, outils, data.</p>
          </div>
          <div className="rounded-xl border p-4">
            <h2 className="font-semibold">🚑 Humanitaire</h2>
            <p className="mt-1 text-sm text-gray-600">MEAL, RRM, SCOPE, coordination.</p>
          </div>
          <div className="rounded-xl border p-4">
            <h2 className="font-semibold">🚀 Entrepreneuriat</h2>
            <p className="mt-1 text-sm text-gray-600">Business, marketing, gestion.</p>
          </div>
        </div>
      </div>
    </main>
